...
template <char const *KEY> class EuiGetter {
private:
...
uint8_t const PROGMEM EuiGetter<KEY>::key[SIZE] = {
    HexCharToInt(KEY[14], KEY[15]), HexCharToInt(KEY[12], KEY[13]),
    HexCharToInt(KEY[10], KEY[11]), HexCharToInt(KEY[8], KEY[9]),
    HexCharToInt(KEY[6], KEY[7]),   HexCharToInt(KEY[4], KEY[5]),
    HexCharToInt(KEY[2], KEY[3]),   HexCharToInt(KEY[0], KEY[1]),
};

template <char const *KEY> class KeyGetter {
private:
...
uint8_t const PROGMEM KeyGetter<KEY>::key[SIZE] = {
    HexCharToInt(KEY[0], KEY[1]),   HexCharToInt(KEY[2], KEY[3]),
    HexCharToInt(KEY[4], KEY[5]),   HexCharToInt(KEY[6], KEY[7]),
    HexCharToInt(KEY[8], KEY[9]),   HexCharToInt(KEY[10], KEY[11]),
    HexCharToInt(KEY[12], KEY[13]), HexCharToInt(KEY[14], KEY[15]),
    HexCharToInt(KEY[16], KEY[17]), HexCharToInt(KEY[18], KEY[19]),
    HexCharToInt(KEY[20], KEY[21]), HexCharToInt(KEY[22], KEY[23]),
    HexCharToInt(KEY[24], KEY[25]), HexCharToInt(KEY[26], KEY[27]),
    HexCharToInt(KEY[28], KEY[29]), HexCharToInt(KEY[30], KEY[31]),
};
