...
void sp1_intial_join(TestServerState &server_state) {
  ...
  TEST_ASSERT(get_mac_command_values(nextPacket) ==
  ...
  printf("Fw version %d.%d.%d.%d\n",versionPayload[1],versionPayload[2],versionPayload[3],versionPayload[4]);
  printf("Lrwan version %d.%d.%d.%d\n",versionPayload[5],versionPayload[6],versionPayload[7],versionPayload[8]);
  printf("Lrwan RP version %d.%d.%d.%d\n",versionPayload[9],versionPayload[10],versionPayload[11],versionPayload[12]);
}
